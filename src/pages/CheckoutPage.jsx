...
export const createOrder = async (orderData) => {
  ...
  // 2. تحضير عناصر الطلب (بدون total_price لأنه عمود منشأ)
  const orderItems = await Promise.all(items.map(async (item) => {
    // جلب اسم المنتج وسعره من جدول products
    ...
    return {
      ...
      product_price: product.price   // ✅ إدراج سعر الوحدة فقط
      // total_price محذوف لأنه GENERATED
    }
  }))
